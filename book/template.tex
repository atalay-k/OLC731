...
\NormalTok{mu }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(iris}\SpecialCharTok{$}\NormalTok{Petal.Length)  }\CommentTok{\# taç yaprak uzunluğu ortalaması}
\NormalTok{sd }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(iris}\SpecialCharTok{$}\NormalTok{Petal.Length) }\CommentTok{\# taç yaprak uzunluğu standart sapması}
...
\caption{Petal Uzunlukları ve Türler}\label{fig:unnamed-chunk-10}
\end{figure}
