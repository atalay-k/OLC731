...
* `r emo::ji("link")`[Hadley Wickham](https://hadley.nz/)
...
**Soru 5.** Fonksiyonları belirlemenin kolay bir yolu aşağıdakilerden hangisine bakmaktır `r mcq(sample(c(answer = "{}", "()", "[]")))`.
