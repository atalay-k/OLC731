...
- Bu paketlere bir örnek yapısal eşitlik modelleri ile ilgili APA formatında tablolar üreten semtools verilebilir. Paketin github sayfası `r emo::ji("link")`[linkte](https://github.com/dr-JT/semoutput) yer almaktadır.  Paketin yüklenemsi için örnek kod aşağıda verilmiştir.
